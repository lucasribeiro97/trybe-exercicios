...
describe('Testa as funcoes encode e decode', () => {
  it('a funcao encode é definida', () => {
    expect(encode).toBeDefined();
  });
  it('encode é uma funcao', () => {
  ...
  it('checa se o retorno da funcao tem o mesmo número de caracteres', () => {
    expect(encode('trybe').length).toEqual(5);
  });

  it('a funcao decode é definida', () => {
    expect(decode).toBeDefined();
  });
  it('decode é uma funcao', () => {
    expect(typeof encode).toEqual('function');
  })
